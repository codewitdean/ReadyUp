...
import { calculateUrgencyScore, getUrgencyLabel } from "../utils/priorityUtils";
type EventCardProps = {
    event: ReadyUpEvent;
...
function EventCard({ event, onCompleteEvent, onDeleteEvent }: EventCardProps) {
    ...
    const urgencyScore = calculateUrgencyScore(event);
        ...
        <article className={`event-card ${event.status === "completed" ? "completed" : ""}`}>
            ...
            <div className="event-details">
                ...
                <p>
                    ...
                    {event.eventFormat === "in_person" ? "In-person" : event.eventFormat}
                </p>
                <p>
                    <strong>Category:</strong> {event.category}
                </p>
                <p>
  <strong>Urgency:</strong> {urgencyLabel} ({urgencyScore}/105)
</p>
